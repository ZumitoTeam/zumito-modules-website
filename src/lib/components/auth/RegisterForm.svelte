...
<form onsubmit={handleSubmit} class="space-y-4">
  ...
  <button type="submit" disabled={loading} class="flex w-full items-center justify-center gap-2 rounded-full bg-zumito-600 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:bg-zumito-700 active:scale-[0.98] disabled:opacity-70 cursor-pointer">
    {#if loading}
