...
<div class="relative inline-flex" onclick={(e: Event) => e.stopPropagation()}>
	...
	{#if open}
		<div class="absolute right-0 top-full z-20 mt-1 min-w-[160px] rounded-xl border border-zinc-200 bg-white p-1 shadow-xl dark:border-zinc-800 dark:bg-zinc-950"
