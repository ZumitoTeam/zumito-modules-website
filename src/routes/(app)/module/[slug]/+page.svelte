...
<div class="mx-auto flex max-w-screen-xl flex-col-reverse gap-12 px-4 py-12 lg:flex-row">
	...
	{/if}
		...
		<div class="mt-8 flex flex-col gap-5 lg:hidden">
			{#if data.mod.dependencies?.length > 0}
				<Card variant="shadow" padding="md" id="deps-section" class="scroll-mt-20">
			...
			{#if data.mod.addons?.length > 0}
				<Card variant="shadow" padding="md" id="addons-section" class="scroll-mt-20">
					<div class="mb-3 flex items-center gap-2 text-lg font-semibold text-zinc-900 dark:text-white">
			...
			{#if data.mod.addonTargets?.length > 0}
				<Card variant="shadow" padding="md" id="addonfor-section" class="scroll-mt-20">
					<div class="mb-3 flex items-center gap-2 text-lg font-semibold text-zinc-900 dark:text-white">
	...
	<div class="flex h-fit w-full flex-col gap-5 lg:sticky lg:top-[10px] lg:w-2/6">
		...
		<!-- Dependencies -->
		{#if data.mod.dependencies?.length > 0}
			<Card variant="shadow" padding="md" class="hidden lg:block scroll-mt-20">
				<div class="mb-3 flex items-center gap-2 text-lg font-semibold text-zinc-900 dark:text-white">
					<svg class="h-5 w-5 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path d="M6.857 4.5h10.286c.955 0 1.857.536 2.329 1.401l1.143 2.057c.388.697.388 1.543 0 2.24l-1.143 2.057a2.571 2.571 0 01-2.329 1.401H6.857a2.571 2.571 0 01-2.329-1.401L3.385 10.2a2.571 2.571 0 010-2.24l1.143-2.057A2.571 2.571 0 016.857 4.5z"/></svg>
					Dependencies
				</div>
		...
		<!-- Sidebar links -->
		<Card variant="shadow" padding="sm" class="overflow-hidden !p-0">
			<button onclick={() => jumpTo('comments-section')} class="flex w-full items-center gap-3 px-5 py-3 text-left text-sm text-zinc-600 transition-colors hover:text-zinc-900 cursor-pointer dark:text-zinc-400 dark:hover:text-zinc-100">
			...
			{#if data.mod.faqs?.length > 0}
				<button onclick={() => jumpTo('faq-section')} class="flex w-full items-center gap-3 border-t border-zinc-200 px-5 py-3 text-left text-sm text-zinc-600 transition-colors hover:text-zinc-900 cursor-pointer dark:border-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
			...
			{/if}
			{#if data.mod.dependencies?.length > 0}
				<button onclick={() => jumpTo('deps-section')} class="flex w-full items-center gap-3 border-t border-zinc-200 px-5 py-3 text-left text-sm text-zinc-600 transition-colors hover:text-zinc-900 cursor-pointer lg:hidden dark:border-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
			...
			{/if}
			{#if data.mod.addons?.length > 0}
				<button onclick={() => jumpTo('addons-section')} class="flex w-full items-center gap-3 border-t border-zinc-200 px-5 py-3 text-left text-sm text-zinc-600 transition-colors hover:text-zinc-900 cursor-pointer lg:hidden dark:border-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
			...
			{/if}
			{#if data.mod.addonTargets?.length > 0}
				<button onclick={() => jumpTo('addonfor-section')} class="flex w-full items-center gap-3 border-t border-zinc-200 px-5 py-3 text-left text-sm text-zinc-600 transition-colors hover:text-zinc-900 cursor-pointer lg:hidden dark:border-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
